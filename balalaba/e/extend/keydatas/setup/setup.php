  ...
  <div class="modal-content">
    ...
    <div class="modal-body clearfix">
      ...
      <form method="post" action="update.php?1=1<?=$ecms_hashur['ehref']?>" name="operationForm" onSubmit="return confirmAction(document.operationForm);">
		...
		<p><?=$ecms_charset_config['configLabel']['version_name_curr']?>：<?php echo $kds_sys_config['version']; ?></p> 
		<p><?=$ecms_charset_config['configLabel']['version_name_lastest']?>：<a href="http://doc.keydatas.com/shuju-fabu-daochu/cha-jian-xia-zai-di-zhi.html#ecms" target="_blank"><?=$ecms_charset_config['configLabel']['view_version']?></a></p> 
    </div>
