...
$keydatas_password_id = "0";
$keydatas_password = "keydatas.com";

$keydatas_title_unique_id = "0";
$keydatas_title_unique="0";
$pubvarRow=$empire->fetch1("select * from {$dbtbpre}enewspubvar where myvar='keydatas_password' limit 1");
if($pubvarRow){
    $keydatas_password_id = $pubvarRow["varid"];
    $keydatas_password = $pubvarRow["varvalue"];
    $pubvarRowTitle = $empire->fetch1("select * from {$dbtbpre}enewspubvar where myvar='keydatas_title_unique' limit 1");
    if($pubvarRowTitle){
		$keydatas_title_unique_id = $pubvarRowTitle['varid'];
        $keydatas_title_unique = $pubvarRowTitle['varvalue'];
    }
}
?>
...
<div class="bodytitle">
	...
	<div class="bodytitletxt" style="padding-left:10px;"><?php echo $ecms_charset_config['configLabel']['page_title'];?>(<b>V<?php echo $kds_sys_config['version']; ?></b>)</div>
</div>
...
<table width="98%"  align="center" cellpadding="4" cellspacing="1" class="tbtitle" style="background:#FFFFFF;">
  <tr>
    	...
    	<strong><?php echo $ecms_charset_config['configLabel']['plus_config_title'];?></strong>
          ...
          <tr>
            ...
            <td><input type="text" id="homeUrl"  name="homeUrl" class="config-input" readonly value="<?php
                                ...
                                echo $domain; ?>" /><?php echo $ecms_charset_config['configLabel']['plus_config_home_url_tip'];?>
            
            </td>
          </tr>
          <tr>
            <td><?php echo $ecms_charset_config['configLabel']['plus_config_password'];?>:</td>
            <td><input type="text" name="keydatas_password" class="config-input" value="<?php echo $keydatas_password; ?>" /><?php echo $ecms_charset_config['configLabel']['plus_config_password_tip'];?>
            </td>
          </tr>
		  <tr>
			<td><?php echo $ecms_charset_config['configLabel']['plus_config_title_unique'];?>:</td>
			<td><input type="checkbox" name="keydatas_title_unique" value="1" <?php if($keydatas_title_unique == 1) echo "checked='checked'" ?> /><?php echo $ecms_charset_config['configLabel']['plus_config_title_unique_yes'];?>
			</td>
		</tr>					  
          <tr>
            <td></td>
    ...
    <input type="hidden" name="keydatas_password_id" value="<?php echo $keydatas_password_id;?>">
    <input type="hidden" name="keydatas_title_unique_id" value="<?php echo $keydatas_title_unique_id;?>">
...
<table width="98%"  border="1" align="center" cellpadding="4" cellspacing="1" class="tbtitle" style="background:#FFFFFF;">
    <td bgcolor="#F9FCEF" colspan="2" background='template/images/tbg.gif' style="padding-left:10px;">
        ...
        <tr>
		  ...
		  <div class="feature"><?php echo $ecms_charset_config['configLabel']['plus_help_feature_2'];?></div>
		  <div class="feature"><?php echo $ecms_charset_config['configLabel']['plus_help_feature_3'];?></div>
		  <div class="feature"><?php echo $ecms_charset_config['configLabel']['plus_help_feature_4'];?></div>
		  <div class="feature"><?php echo $ecms_charset_config['configLabel']['plus_help_feature_5'];?></div>
		  <div class="feature"><?php echo $ecms_charset_config['configLabel']['plus_help_feature_6'];?></div>
		  </td>
        </tr>		
      </table>
    </div>
