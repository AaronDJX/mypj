...
E_D("DROP TABLE IF EXISTS `think_enewsmoreport`;");
E_C("CREATE TABLE `think_enewsmoreport` (
...
E_D("replace into `think_enewsmoreport` values('1',0xe4b8bbe8aebfe997aee7abaf,'','','','','0','0','0','0','','0','0');");
