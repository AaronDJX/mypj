...
E_D("DROP TABLE IF EXISTS `think_enewspublic_up`;");
E_C("CREATE TABLE `think_enewspublic_up` (
...
E_D("replace into `think_enewspublic_up` values('1','1355124469','1355124476','14','0',0x7c312c31347c,'','1681368408','1681368408','6','0','0','0');");
