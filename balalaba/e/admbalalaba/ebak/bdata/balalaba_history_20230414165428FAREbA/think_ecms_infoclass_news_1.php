...
E_D("DROP TABLE IF EXISTS `think_ecms_infoclass_news`;");
E_C("CREATE TABLE `think_ecms_infoclass_news` (
  ...
  `zz_yuanchuang` text NOT NULL,
  `z_yuanchuang` varchar(255) NOT NULL,
  `qz_yuanchuang` varchar(255) NOT NULL,
  `save_yuanchuang` varchar(10) NOT NULL,
  PRIMARY KEY (`classid`)
