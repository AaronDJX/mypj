...
E_D("DROP TABLE IF EXISTS `think_enewsclass_stats_set`;");
E_C("CREATE TABLE `think_enewsclass_stats_set` (
...
E_D("replace into `think_enewsclass_stats_set` values('0','3600','0','20170227');");
