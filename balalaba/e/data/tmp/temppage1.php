...
<article>
  <nav>
    <div class="topnav">
      <ul id="starlist">
        <li><a href="[!--news.url--]">最新资讯</a></li>
        <li><a href="[!--news.url--]tuijian/">推荐内容</a></li>
        <li><a href="[!--news.url--]hot/">热门内容</a></li>
<? @sys_ShowClassByTemp('0',12,0,0);?> 
      </ul>
    </div>
    <em></em> </nav>
  <div class="box_l">
    <div class="weizhi"><a href="[!--news.url--]" target="_blank">外贸平台</a> / [!--pagetitle--]</div>
    <div class="con_tit">
      <h1>[!--pagetitle--]</h1>
    </div>
    <div class="con_tags"> <?php
$bqno=0;
$ecms_bq_sql=sys_ReturnEcmsLoopBq("select tagname from [!db.pre!]enewstags order by num DESC limit 200",0,24,0);
if($ecms_bq_sql){
...
?>
<?
echo '<a href="'.$public_r[newsurl].'tag/'.urlencode($bqr['tagname']).'.html">'.$bqr['tagname'].'</a>';
?>
<?php
}
}
...
?>
    ...
    <div class="tags">
      <div class="side_title"><a href="[!--news.url--]tags.html">更多</a>
        <h3>热门标签</h3>
      </div>
      <ul>
<ul>
...
<div class="side_nav">
  <ul>
    <li><a href="[!--news.url--]<?=$class_r[8]['classpath']?>" title="关于贸管家"><i class="icon_ab"><img src="[!--news.url--]skin/html/images/ft_about.png" alt=""></i> </a></li>
    <li><a title="每日询盘"><i class="icon_wx"><img src="[!--news.url--]skin/html/images/ft_qq.png" alt=""></i><span><img src="[!--news.url--]skin/html/images/qq.png" alt="qq"></span> </a></li>	
    <li><a title="免费试用"><i class="icon_wx"><img src="[!--news.url--]skin/html/images/ft_ewm.png" alt=""></i><span><img src="[!--news.url--]skin/html/images/wx.png" alt="微信"></span> </a></li>
    <li><a href="#" class="icon-top" title="返回顶部"><i class="icon_fh"><img src="[!--news.url--]skin/html/images/ft_top.png" alt=""></i> </a></li>
  </ul>
</div>
<script>
    new Vue({
