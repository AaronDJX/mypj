...
<link href="[!--news.url--]skin/html/css/swiper.min.css" rel="stylesheet">
...
<? @sys_ShowClassByTemp('0',12,0,0);?> 
    ...
    <em></em> </nav>
  <div class="box_l">
    <div class="weizhi"><a href="[!--news.url--]" target="_blank">首页</a> / [!--pagetitle--]</div>
    <div class="con_tit">
      <h1>[!--pagetitle--]</h1>
    </div>
    <div class="con_tags"> <? @sys_eShowTags('',0,0,'',0,'',' ',0,'','tagname');?></div>
  </div>
  <div class="box_r">
    <div class="hot_news">
