...
?>  <tr bgcolor="#FFFFFF"> 
  ...
  <tr bgcolor="#FFFFFF"> 
    <td height="22" valign="top"><strong>原创正则：</strong><br>
      (<input name="textfield" type="text" id="textfield" value="[!--yuanchuang--]" size="20">)</td>
    <td><table width="100%" border="0" cellspacing="1" cellpadding="3">
        <tr> 
          <td><textarea name="add[zz_yuanchuang]" cols="60" rows="10" id="textarea"><?=ehtmlspecialchars(stripSlashes($r[zz_yuanchuang]))?></textarea></td>
        </tr>
        <tr> 
          <td><input name="add[z_yuanchuang]" type="text" id="add[z_yuanchuang]" value="<?=stripSlashes($r[z_yuanchuang])?>">
            (如填写这里，将为字段的值)</td>
        </tr>
      </table></td>
  </tr>
