...
</table></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>原创</td><td bgcolor='ffffff'><input name="yuanchuang[]" type="checkbox" value="是"<?=strstr($r[yuanchuang],"|是|")?' checked':''?>>是</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>特殊属性</td><td bgcolor='ffffff'><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#DBEAF5">
  <tr>
