...
{
?>
document.write("&raquo;&nbsp;<font color=red><b><?=$myusername?></b></font>&nbsp;&nbsp;<a href=\"http://balalaba.historyhots.com/e/member/my/\" target=\"_parent\"><?=$groupname?></a>&nbsp;<?=$havemsg?>&nbsp;<a href=\"http://balalaba.historyhots.com/e/space/?userid=<?=$myuserid?>\" target=_blank>我的空间</a>&nbsp;&nbsp;<a href=\"http://balalaba.historyhots.com/e/member/msg/\" target=_blank>短信息</a>&nbsp;&nbsp;<a href=\"http://balalaba.historyhots.com/e/member/fava/\" target=_blank>收藏夹</a>&nbsp;&nbsp;<a href=\"http://balalaba.historyhots.com/e/member/cp/\" target=\"_parent\">控制面板</a>&nbsp;&nbsp;<a href=\"http://balalaba.historyhots.com/e/member/doaction.php?enews=exit&ecmsfrom=9\" onclick=\"return confirm(\'确认要退出?\');\">退出</a>");
<?php
	db_close();
	$empire=null;
}
